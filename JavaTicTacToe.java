...
public class JavaTicTacToe implements ActionListener {
	...
	boolean victory = false; // flags if there is a victory
	...
	public void checkDraw() {
		...
		if (buttonsPressed == 9) {
			playerInfo.setBounds(80,613, 300, 35); // centralize text
	...
	public void setVictory(int a, int b, int c, String p) {
		...
		if (p.equals("X")) {
			...
			playerInfo.setText("Player X is the winner!"); // show message
			playerInfo.setBounds(90,613, 300, 35); // centralize information
		}
		...
		if (p.equals("O")) {
			...
			playerInfo.setText("Player O is the winner!"); // show message
			playerInfo.setBounds(90,613, 300, 35); // centralize information
	...
	public void setTurn() {
		...
		// if is xTurn and the game is running, show message
		if (xTurn && victory == false) {
			playerInfo.setText("Player X turn");
		}
		
		// if is O Turn and the game is running, show message
		if (xTurn == false && victory == false) { 
	...
	public void actionPerformed(ActionEvent e) {
		...
		for(int i = 0; i < 9; i ++) {
			...
			if (e.getSource() == restartButton) {
				...
				victory = false; // set victory to false, to continue the game
				setTurn(); // sets turn
